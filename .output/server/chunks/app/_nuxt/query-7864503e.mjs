...
import { x as withLeadingSlash, j as joinURL, t as withoutTrailingSlash, y as withBase, v as hash } from '../../nitro/node-server.mjs';
import { a as useRequestEvent, u as useContentPreview } from './preview-8a59dd4b.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-df445ef5.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-7864503e.mjs.map
