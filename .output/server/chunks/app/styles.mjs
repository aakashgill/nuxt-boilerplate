...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.229946d9.mjs').then(interopDefault),
  ...
  "layouts/default.vue": () => import('./_nuxt/default-styles.ecb93f1d.mjs').then(interopDefault)
};
